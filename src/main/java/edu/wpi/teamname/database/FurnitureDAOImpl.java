...
public class FurnitureDAOImpl implements FurnitureDAO {
    ...
    public static void exportFurnitureToCSV(String csvFilePath) throws SQLException, IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(csvFilePath))) {
            ...
            while (resultSet.next()) {
                ...
                String row = id + "," + name + "," + price + "," + category + "," + size + "," + color + "\n";
                writer.write(row);
            }
     ...
     */
    public static void uploadFurnitureToPostgreSQL(String csvFilePath) throws SQLException, ParseException {
        List<String[]> csvData;
        Connection connection = DataManager.DbConnection();
        ...
        try (connection) {
            String query = "INSERT INTO \"Furniture\" (\"furnitureID\", \"name\", \"price\", \"category\", \"size\", \"color\") VALUES (?, ?, ?, ?, ?, ?)";
