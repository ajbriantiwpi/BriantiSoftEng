...
public class PathMessageDAOImpl implements PathMessageDAO {
    ...
    /**
     * This method updates an existing PathMessage object in the "PathMessages" table in the database with the new
     * PathMessage object.
     *
    ...
    public void add(PathMessage pm) throws SQLException {
        Connection connection = DataManager.DbConnection();
        try (connection) {
            String query = "INSERT INTO \"PathMessages\" (\"startNode\", \"endNode\", algorithm, \"date\", \"adminID\", message) VALUES (?, ?, ?, ?, ?, ?)";
            PreparedStatement statement = connection.prepareStatement(query);
    ...
    public void delete(PathMessage pm) throws SQLException {
        ...
        String del = "Delete ";
        String sel = "Select * ";
        String query = "FROM \"PathMessages\" WHERE \"startNode\" = ? AND \"endNode\" = ?, AND \"algorithm\" = ?";
        try (connection) {
    ...
    /**
     * Uploads CSV data to a PostgreSQL database table "PathMessagea"-also creates one if one does not exist
     *
    ...
    /**
     * This method exports all the PathMessage objects from the "PathMessages" table in the database to a CSV file at
