...
public class OfficeSupplyDAOImpl implements OfficeSupplyDAO {
     ...
     */
    public static void uploadOfficeSupplyToPostgreSQL(String csvFilePath) throws SQLException, ParseException {
        List<String[]> csvData;
        Connection connection = DataManager.DbConnection();
        ...
        try (connection) {
            String query = "INSERT INTO \"OfficeSupply\" (\"supplyID\", \"name\", \"price\", \"category\", \"isElectric\") VALUES (?, ?, ?, ?, ?, ?)";
