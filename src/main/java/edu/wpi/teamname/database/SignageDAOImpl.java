...
public class SignageDAOImpl implements SignageDAO {
    ...
    public void sync(Signage signage) throws SQLException {
        ...
        try (connection) {
            String query =
                    "UPDATE \"Signage\" SET \"shortName\" = ?, \"date\" = ?, \"arrowDirection\" = ?"
                            + " WHERE \"longName\" = ?";
            ...
            statement.setString(4, signage.getLongName());
    ...
    public ArrayList<Signage> getAll() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(new Signage(longn, shortn, date, arrowDirection));
            }
        } catch (SQLException e) {
    ...
    public void add(Signage signage) throws SQLException {
        Connection connection = DataManager.DbConnection();
        String query =
                "INSERT INTO \"Signage\" (\"longName\", \"shortName\", \"date\", \"arrowDirection\") "
                        + "VALUES (?, ?, ?, ?)";
    ...
    public void delete(Signage signage) throws SQLException {
        ...
        String del = "DELETE ";
        String sel = "SELECT * ";
        String query = "FROM \"Signage\" WHERE \"longName\" = ?";
