  ...
  public void setLanguage(Language lang) throws SQLException {
    switch (lang) {
      case ENGLISH:
        ...
        break;
      case FRENCH:
        ParentController.titleString.set("Vue des r"+GlobalVariables.getEAcute() +"servations de salle de conf"+GlobalVariables.getEAcute() +"rence");
        ...
        assignStaffLabel.setText("Assigner le personnel "+GlobalVariables.getAGrave()+" la r"+GlobalVariables.getEAcute() +"servation");
        idLabel.setText("ID de r"+GlobalVariables.getEAcute() +"servation");
        reservationIDText.setPromptText("S"+GlobalVariables.getEAcute() +"lectionner l'ID de r"+GlobalVariables.getEAcute() +"servation");
        assignStaffLabel1.setText("Assigner le personnel");
        assignStaffText.setPromptText("S"+GlobalVariables.getEAcute() +"lectionner le personnel");
