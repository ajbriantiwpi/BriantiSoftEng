...
public class AlertTableViewController {
    ...
    @FXML
    TableView<Alert> table; // 15
    @FXML
    TableColumn notificationIDCol; // 7
    @FXML
    TableColumn Description; // 8
    @FXML
    TableColumn authorCol; // 9
    @FXML
    TableColumn startDateCol; // 10
    @FXML
    TableColumn endDateCol; // 11
    @FXML
    TableColumn staffTypeCol; // 12
    @FXML
    TableColumn announcementCol; // 13
    @FXML
    TableColumn urgencyCol; // 14
    @FXML
    TextField searchTextField; // 16
    @FXML
    SearchableComboBox<Integer> alertIDAssign; // 4
    @FXML
    SearchableComboBox<String> assignStaffText; // 5
    @FXML
    MFXButton submitButton; // 6
    @FXML
    Label detailsLabel;
    @FXML
    Label detailsLabel1;
    ...
    @FXML
    MFXButton ViewButton;
    @FXML
    MFXButton createNewAlert; // 3
    @FXML
    ComboBox<EmployeeType> staffTypeCombo; // 2
    @FXML
    ComboBox<Alert.Urgency> urgencyCombo; // 1

    public void makeNewAlert(int id,
                             Timestamp start,
                             Timestamp end,
                             EmployeeType type,
                             String description,
                    ...
                    public void handle(MouseEvent event) {
                        ...
                        submit.setOnMouseClicked(
                                event1 -> {
                                    ...
                                    try {
                                        if(urgencies.valueProperty() == null) {
                                            makeNewAlert(
