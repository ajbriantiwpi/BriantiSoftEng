...
public class MapController {
    @FXML
    Label mapSymbolsLabel;

    @FXML
    Label conferenceRoomLabel;
    ...
    @FXML
    Label currentFloorStart;
    @FXML
    Label currentFloorDestLabel;
    ...
    HBox SelectCombo;
    @FXML
    ComboBox<String> LocationOne;
    public static ComboBox<String> LocOne;
    @FXML
    ComboBox<String> EndPointSelect;
    public static ComboBox<String> endSel;
    @FXML
    MFXButton DeleteNodeButton;
    @FXML
    MFXButton findPathButton;
    // @FXML ComboBox<String> FloorSelect = new ComboBox<>();
    @FXML
    ComboBox<String> AlgoSelect = new ComboBox<>();

    @FXML
    CheckBox LongNameSelector;
    @FXML
    CheckBox ShortNameSelector;
    @FXML
    CheckBox IdSelector;
    ArrayList<CheckBox> nameSelectBoxes = new ArrayList<>();
    @FXML
    CheckBox EdgeSelector;
    @FXML
    CheckBox HallNamesSelector;
    @FXML
    CheckBox NodeSelector;
    @FXML
    CheckBox LegendSelector;
    @FXML
    CheckBox AvoidElevatorsToggle;

    @FXML
    CheckBox FloorsToggle = new CheckBox();

    @FXML
    DatePicker datePickerUI;
    ...
    MFXButton upFloor;
    @FXML
    MFXButton ViewMessageButton;
    @FXML
    MFXButton AddMessageButton;

    @FXML
    HBox floorSelector;

    @FXML
    AnchorPane OuterMapAnchor;
    @FXML
    TableView<PathMessage> MessageTableView;

    @FXML
    TableColumn<PathMessage, Timestamp> DateColumn;
    @FXML
    TableColumn<PathMessage, Integer> AdminColumn;
    @FXML
    TableColumn<PathMessage, String> MessageColumn;

    // Add Message Pop-Up
    @FXML
    TextField AdminIDVal;
    @FXML
    TextField MessageVal;
    @FXML
    Label AdminIDLabel;
    @FXML
    Label MessageLabel;
    ...
    VBox AddMessageVBox;
    @FXML
    MFXButton MessageSubmitButton;

    // New Floor Button Layout
    @FXML
    MFXButton ThirdFloorButton;
    @FXML
    MFXButton SecondFloorButton;
    @FXML
    MFXButton FirstFloorButton;
    @FXML
    MFXButton LowerFirstButton;
    @FXML
    MFXButton LowerSecondButton;
    ...
    @FXML
    TitledPane PathfindingTitlePane;
    @FXML
    TitledPane DirectionsTitlePane;
    @FXML
    TitledPane FloorTitlePane;
    @FXML
    TitledPane TickTitlePane;
    @FXML
    TitledPane DateTitlePane;
    @FXML
    TitledPane MessageTitlePane;
