  ...
  public void setLanguage(Language lang) {
    switch (lang) {
      ...
      case ITALIAN:
        ...
        break;
      case FRENCH:
        ParentController.titleString.set("Demande de salle de conf"+GlobalVariables.getEAcute() +"rence");
        dateLabel.setText("Date");
      ...
      case SPANISH:
        ...
        endBox.setPromptText("Seleccione la hora de finalizaci"+GlobalVariables.getOAcute() +"n");
