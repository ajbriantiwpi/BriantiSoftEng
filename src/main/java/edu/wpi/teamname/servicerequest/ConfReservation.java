...
public class ConfReservation {
    ...
    public ConfReservation(int resID, String startT, String endT, Timestamp dateBook, Timestamp dateMade, String name, String username, String staff){
        this.resID = resID;
    ...
    public String toString(){
        return "Reservation ID: "+resID+", Start Time: "+startTime+", End Time: " + endTime +", Date Booked: "+dateBook+", Date Made: "+dateMade
                +", Name: "+name+", Username: "+username+", Assigned Staff: "+staffAssigned;
    }
}
